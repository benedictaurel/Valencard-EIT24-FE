...
const Formulir = () => {
    return (
      <>
        <div className='flex justify-center items-center min-h-screen bg-gradient-to-t from-bgsuccess to-tobgsuccess px-[96.5px] overflow-hidden'>
          <div className="relative w-full max-w-[1247px] py-10 px-[166.5px] bg-white rounded-[20px] text-center shadow-xl shadow-shadowcard">
            <div className="text-center mb-5">
              <h1 className='lg:text-[100px] sm:text-[50px] text-brown1 font-titanone font-normal inline-flex justify-center items-center'>
                  Card Form
                  <img src={msgform} alt="gambar surat di form" className="ml-4" style={{ width: 'auto', height: '100px' }} />
              </h1>
            </div>
